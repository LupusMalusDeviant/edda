...
/// <summary>
/// Unit tests for <see cref="OpenAiEmbeddingService"/> batch embedding: a single request per batch and
/// index-based reordering of the response.
/// </summary>
public class OpenAiEmbeddingServiceTests
{
    ...
    public async Task EmbedBatchAsync_AboveMaxBatchSize_SplitsIntoMultipleRequests()
    {
        ...
        var count = OpenAiEmbeddingService.MaxBatchSize + 2; // → two batches
    ...
    private static OpenAiEmbeddingService BuildService(Action onRequest)
    {
        ...
        return new OpenAiEmbeddingService(
            factory.Object, "test-key", new Mock<ILogger<OpenAiEmbeddingService>>().Object);
    }
}
